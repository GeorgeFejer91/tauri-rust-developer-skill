...
- Read [browser-companion-reliability.md](references/browser-companion-reliability.md) when designing or auditing password-only pairing, remembered browsers, WebRTC/WebSocket reachability, reconnect behavior, acknowledgement-loss retries, authoritative snapshots or media timelines, browser-to-loopback bridges, bulk transfer beside interactive control, or end-to-end latency/compatibility qualification. Use it with the Marionette reference for mutation-capable companions.
